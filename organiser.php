...
if(isset($_POST['username'])&& isset($_POST['password']))
{
    $username=$_POST['username'];
      ...
      {
       $query="SELECT `id` FROM `modifier` WHERE `username`='$username' AND `password`='$password_hash' AND `usertype`='$category'";
          ...
          if($query_run= mysqli_query($conn, $query))
              ...
              {   $_SESSION['user_name']=$username;
               ...
               $_SESSION['user_id']=$row['id'];
                   header("Location:organiser-homepage.php");
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-md-12" style="margin-top: 50px; margin-bottom: 50px">
	  <table style="width:100%">
		<tr>
			...
			<td><button type="button" class="btn btn-primary btn-block btn-lg active" style="border-radius: 0">Organiser Login</button></td>
	...
	<div class="col-md-12" style="margin-top: 50px; margin-bottom: 50px">
	<form class="form-inline" role="form" action="organiser.php" method="POST">
