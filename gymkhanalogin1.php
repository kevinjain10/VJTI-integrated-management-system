...
session_start();
  ...
  if(isset($_POST["confirmation"]))
    ...
    {
     $querri="INSERT INTO `gymkhana`(`sr.no`,`slotno`,`username`,`game`)
     VALUES('','{$_SESSION['slotno']}','{$_SESSION['user_name']}','{$_SESSION['game']}')";
        if(mysqli_query($conn,$querri))
         {
          header('Location:gymkhanabookingsuccess.php');
         	}
                  else {
     	  	 echo "Error: " . $querri . "<br>" . mysqli_error($conn);
    	              }
     }
...
<div id="nav">
 ...
 <form action="gymkhanalogin1.php" method="POST">
 <br>
