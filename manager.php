...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-md-12" style="margin-top: 50px; margin-bottom: 50px">
	  <table style="width:100%">
		<tr>
			...
			<td><button type="button" class="btn btn-primary btn-block btn-lg active" style="border-radius: 0">Manager Login</button></td>
	...
	<div class="col-md-12" style="margin-top: 50px; margin-bottom: 50px ">
	<form class="form-inline" role="form" method="POST" action="manager.php">
